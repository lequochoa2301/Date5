...
@Configuration
@EnableJpaRepositories(basePackages = "spring.jpa.repository")
...
public class SpringConfigJPA {
    ...
    DataSource dataSource() {
        ...
        dataSource.setUrl("jdbc:mysql://localhost:3306/demo5?characterEncoding=UTF-8&createDatabaseIfNotExist=true");
